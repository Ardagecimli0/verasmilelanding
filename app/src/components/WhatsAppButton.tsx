...
export default function WhatsAppButton({ phoneNumber: _phoneNumber }: WhatsAppButtonProps) {
  ...
  const handleOpenChat = () => {
    window.open('https://api.whatsapp.com/send/?phone=15557531839&text=Hello%2C+I%E2%80%99m+interested+in+learning+more+about+your+dental+treatments.+%0D%0ACould+you+please+provide+me+with+more+information%3F+%0D%0AThank+you%21&type=phone_number&app_absent=0', '_blank');
  };
            ...
            >
              ...
              <div className="bg-[#075E54] px-4 py-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img
                    src="/images/529663926_773755718352702_5975255884687431767_n (1).jpg"
                    alt="VeraSmile"
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-white/80 text-xs">{t('online')}</span>
                    </div>
                  </div>
                </div>
                <button
